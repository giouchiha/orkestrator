...
You can help with one of the following:

1. Review and Editon for technical documentation.
2. Functional testing for ansible general roles.
3. Functional testing for ansible jenkins roles.
